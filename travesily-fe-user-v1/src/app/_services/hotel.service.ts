...
export class HotelService {
  ...
  searchHotel(
    ...
    return this.http.get(`${this.baseUrl}/public/search-hotel`, {
  ...
  listBenefitsByHotelId(hotelId: string) {
    ...
    return this.http.get(`${this.baseUrl}/public/list-hotel-benefit`, {
      withCredentials: false,
      params: params,
    });
  }
  ...
  getHotelById(hotelId: string) {
    const params = new HttpParams().append('hotelId', hotelId);
    return this.http.get(`${this.baseUrl}/public/hotel`, {
      withCredentials: false,
      params: params,
    });
  }
