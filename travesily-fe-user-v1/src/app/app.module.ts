...
} from './components/master/body/body-user/user-profile/user-profile-details/user-profile-details.component';
import {AuthInterceptor} from "./_helper/auth.interceptor";
import {
  UserProfileDetailsInfoComponent
} from './components/master/body/body-user/user-profile/user-profile-details/user-profile-details-info/user-profile-details-info.component';
import {
  EditDropdownNameComponent
} from './components/master/body/body-user/user-profile/user-profile-details/edit-dropdown-name/edit-dropdown-name.component';
import {
  EditDropdownPasswordComponent
} from './components/master/body/body-user/user-profile/user-profile-details/edit-dropdown-password/edit-dropdown-password.component';
import {
  EditDropdownAddPhoneComponent
} from './components/master/body/body-user/user-profile/user-profile-details/edit-dropdown-add-phone/edit-dropdown-add-phone.component';
import {
  EditDropdownEditPhoneComponent
} from './components/master/body/body-user/user-profile/user-profile-details/edit-dropdown-edit-phone/edit-dropdown-edit-phone.component';
...
} from './components/master/body/body-user/user-bookings/booking-card/booking-card.component';
...
} from './components/master/body/body-user/user-bookings/user-booking-detail/user-booking-detail-card/user-booking-detail-card.component';
...
} from './components/master/body/body-main/hotel-detail/room-type-card/room-type-card.component';
...
} from './components/master/body/body-book/booking-information/booking-information-detail/booking-information-detail.component';
import {
...
} from './components/master/body/body-book/booking-transaction-information/transaction-cod/transaction-cod.component';
import {
  TransactionVnpayComponent
} from './components/master/body/body-book/booking-transaction-information/transaction-vnpay/transaction-vnpay.component';
import {
  TransactionBookingDetailComponent
} from './components/master/body/body-book/booking-transaction-information/transaction-booking-detail/transaction-booking-detail.component';
...
} from './components/master/body/body-home/top-hotels/hotel-mini-card/hotel-mini-card.component';
...
} from './components/master/body/body-home/top-location/location-card/location-card.component';
...
} from './components/master/body/body-user/user-feedback/feedback-card/feedback-card.component';
import {
  FeedbackDetailComponent
} from './components/master/body/body-user/user-feedback/feedback-detail/feedback-detail.component';
import {
  ResponseMessageComponent
} from './components/master/body/body-user/user-feedback/feedback-detail/response-message/response-message.component';
import {NgxSpinnerModule} from "ngx-spinner";
import {NgxScrollTopModule} from "ngx-scrolltop";
import {
  UserVipVipDataComponent
} from './components/master/body/body-user/user-vip/user-vip-vip-data/user-vip-vip-data.component';
import {CouponDialogComponent} from './shared/components/coupon-dialog/coupon-dialog.component';
import {MatDialogModule} from '@angular/material/dialog'
import {
  HotelRatingComponent
} from "./components/master/body/body-main/hotel-detail/hotel-rating/hotel-rating.component";
